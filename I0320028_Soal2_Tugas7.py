print("=====Program menentukan nilai max dan min dari nilai akar kuadrat 3 bilangan yang dibulatkan ke atas=====")
...
print("nilai max hasil pembulatan nilai akar kuadrat= ", max(pembulatan_pertama,pembulatan_kedua,pembulatan_ketiga))
print("nilai min hasil pembulatan nilai akar kuadrat= ", min(pembulatan_pertama,pembulatan_kedua,pembulatan_ketiga))